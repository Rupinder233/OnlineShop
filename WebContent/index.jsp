	...
	<div class="header-bot">
		<div class="container">
			<div class="col-md-3 header-left">
				<h1>
					<a href="index-2.html"><img src="images/logo33.jpg"></a>
				</h1>
			</div>
		...
		<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/ba1.jpg"/></li>
					<li><img class="img-responsive" src="images/ba2.jpg"/></li>
					<li><img class="img-responsive" src="images/ba3.jpg"/></li>
				</ul>
